import os
import sys
sys.path.append('/Users/madsbertelsen/McStas/pan-training-simulations/elearning-instrumentfiles/intro-ns')
import compare_data
os.chdir("reflectometer_run")
"""
...
reflectometer.add_parameter("double", "lambda_min", value=5.3)
reflectometer.add_parameter("double", "lambda_max", value=5.45)
reflectometer.add_parameter("double", "slittranslation", value=0.0)
reflectometer.add_parameter("double", "sampletranslation", value=0.0)
reflectometer.add_parameter("double", "slitwidth", value=0.001)
reflectometer.add_parameter("double", "slitheight", value=0.002)
reflectometer.add_parameter("double", "dist_source2slit", value=1.0)
reflectometer.add_parameter("double", "dist_slit2slit", value=3.2)
reflectometer.add_parameter("double", "dist_slit2sample", value=0.18)
reflectometer.add_parameter("double", "dist_sample2detector", value=2.0)
reflectometer.add_parameter("double", "sampletype", value=1.0)
reflectometer.add_parameter("double", "samplesize", value=0.15)
reflectometer.add_parameter("double", "substratethickness", value=0.003)
reflectometer.add_parameter("double", "MR_Qc", value=0.15)
reflectometer.add_parameter("double", "sampleangle", value=2.5)
reflectometer.add_parameter("double", "detectorangle", value=5.0)
...
data = reflectometer.run_full_instrument(foldername="py_data_reflectometer",ncount=1000000,seed=312,increment_folder_name=True)

ref_data = functions.load_data("../data_folder/ref_data_reflectometer")

co = compare_data.compare_engine(name="reflectometer")
co.run_comparison(data, ref_data)
co.print_history(show_all=True)
filename="../logs/20230110_145054/reflectometer_file_result.log"
co.write_history_to_file(filename=filename, mode='a', show_all=True)
